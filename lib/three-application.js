...
function Application(options = {}) {
  ...
  const screen = new three.Vector2(0, 0);
  ...
  const app = Object.create(three.EventDispatcher.prototype, {
  ...
  if (options.addShaderChunk !== false) {
    ...
    three.ShaderChunk.app = shaderchunk;
  ...
  function handleMousemove() {
    ...
    const normalizedX = three.Math.clamp((2 * queuedMousemoveEvent.clientX / width) - 1, -1, 1);
    const normalizedY = three.Math.clamp((2 * -queuedMousemoveEvent.clientY / height) + 1, -1, 1);
